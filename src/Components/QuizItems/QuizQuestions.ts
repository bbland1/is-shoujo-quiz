...
const questions = [
  ...
  },
  {
    ...
    question_description:
      'Synopsis: The summer of freshman year of high school. A boy named Hodaka runs away from his island home and goes to Tokyo, where he spends every day in loneliness. Then, in a corner of the bustling city, he meets a girl named Hina. But he soon finds out that she possesses a mysterious power.(Source: Vertical Inc.)',
  ...
  },
  {
    ...
    question_description:
      "Synopsis: Totonou is a young man who stands out-partly for his bushy hair, partly for his finely honed abilities of observation and deduction. When Totonou is accused of murder, he puts his skills to work delving into the lives of the cops investigating him and uses his insights to find the real murderer. After clearing his name, all Totonou wants to do is return to his laidback, mundane life, but he can't help but be drawn into one mystery after another. In his own blunt but gentle way, Totonou is just trying to make sense of a chaotic world.(Source: Seven Seas Entertainment)",
  ...
  },
  {
    ...
    question_description:
      'Synopsis: Shiro, a laid-back and absentmindedly seductive umbrella craftsman, is (surprisingly) a close friend of Koujirou, a hot-blooded young police officer who stands against all things undisciplined. With their mutual knack for attracting trouble, the pair soon find themselves involved in a bloody and erotic thrill-ride in their off-kilter town full of equally off-kilter people. This action-packed, jack-of-all-trades manga will have you swooning at its sexiness and leave you more addicted than opium—guaranteed! (Source: Anilist)',
  ...
  },
  {
    ...
    question_description:
      "Synopsis: Growing up, Nobuko Tanaka was always a 'side character' standing off in the corner. Now in her 20s, she's fallen in love for the first time. While she isn't any good at being assertive, she will muster her courage bit by bit as she tries her best to close the distance between herself and her crush - because even side characters fall in love. If you're tired of the same old romantic protagonists, this modest, refreshing love story is for you. (Source: Book Walker Global)",
